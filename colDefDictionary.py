    ...
    return {
        ...
        "columnDefs": [
            ...
            {   'headerName': '2022',
                 ...
                 'openByDefault':True,
                 'children': [
                     {'field': 'Jan22', 'columnGroupShow':'open', 'editable':False, 'resizable':False, 'suppressSizeToFit':True, 'suppressAutoSize':True, 'filter':False, 'width':75, 'cellStyle':{'background-color':'blue'}},
